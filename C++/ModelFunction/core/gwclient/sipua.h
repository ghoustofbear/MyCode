...
public:
	...
	SipUA(string bindIp, int port, char *addrcode);
    virtual ~SipUA();
...
public:
    ...
    virtual int        subscribe(const string &ton, const string &toh, int top, 
                                 const string &event, int expires, const string &xml, string &jresp);

	virtual int        refreshsubscribe(const string &ton, const string &toh, int top,
		                  const string &event, int expires, const string &xml, string &jresp);

    virtual int        message(const string &ton, const string &toh, int top, 
                               const string &xml, string &xresp);

    virtual int        invite (const string &ton, const string &toh, int top, 
                               const string &sdp, string &jresp);

    virtual int        notify (const string &ton, const string &toh, int top, 
...
protected:
    ...
    tmap<string, int>  m_toPortMap;                        /* invite sdp to port map */
