...
#include "soapH.h"
    ...
    class SOAP_CMAC DisplayBindingProxy : public soap {
      public:
        ...
        DisplayBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int GetLayout(const char *soap_endpoint_url, const char *soap_action, _tls__GetLayout *tls__GetLayout, _tls__GetLayoutResponse &tls__GetLayoutResponse) { return this->send_GetLayout(soap_endpoint_url, soap_action, tls__GetLayout) || this->recv_GetLayout(tls__GetLayoutResponse) ? this->error : SOAP_OK; }
        ...
        virtual int SetLayout(const char *soap_endpoint_url, const char *soap_action, _tls__SetLayout *tls__SetLayout, _tls__SetLayoutResponse &tls__SetLayoutResponse) { return this->send_SetLayout(soap_endpoint_url, soap_action, tls__SetLayout) || this->recv_SetLayout(tls__SetLayoutResponse) ? this->error : SOAP_OK; }
        ...
        virtual int SetPaneConfiguration(const char *soap_endpoint_url, const char *soap_action, _tls__SetPaneConfiguration *tls__SetPaneConfiguration, _tls__SetPaneConfigurationResponse &tls__SetPaneConfigurationResponse) { return this->send_SetPaneConfiguration(soap_endpoint_url, soap_action, tls__SetPaneConfiguration) || this->recv_SetPaneConfiguration(tls__SetPaneConfigurationResponse) ? this->error : SOAP_OK; }
