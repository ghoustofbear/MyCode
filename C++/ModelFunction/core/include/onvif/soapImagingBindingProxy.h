...
#include "soapH.h"
    ...
    class SOAP_CMAC ImagingBindingProxy : public soap {
      public:
        ...
        ImagingBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int GetOptions(const char *soap_endpoint_url, const char *soap_action, _timg__GetOptions *timg__GetOptions, _timg__GetOptionsResponse &timg__GetOptionsResponse) { return this->send_GetOptions(soap_endpoint_url, soap_action, timg__GetOptions) || this->recv_GetOptions(timg__GetOptionsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int Move(const char *soap_endpoint_url, const char *soap_action, _timg__Move *timg__Move, _timg__MoveResponse &timg__MoveResponse) { return this->send_Move(soap_endpoint_url, soap_action, timg__Move) || this->recv_Move(timg__MoveResponse) ? this->error : SOAP_OK; }
        ...
        virtual int Stop(const char *soap_endpoint_url, const char *soap_action, _timg__Stop *timg__Stop, _timg__StopResponse &timg__StopResponse) { return this->send_Stop(soap_endpoint_url, soap_action, timg__Stop) || this->recv_Stop(timg__StopResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetStatus(const char *soap_endpoint_url, const char *soap_action, _timg__GetStatus *timg__GetStatus, _timg__GetStatusResponse &timg__GetStatusResponse) { return this->send_GetStatus(soap_endpoint_url, soap_action, timg__GetStatus) || this->recv_GetStatus(timg__GetStatusResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetPresets(const char *soap_endpoint_url, const char *soap_action, _timg__GetPresets *timg__GetPresets, _timg__GetPresetsResponse &timg__GetPresetsResponse) { return this->send_GetPresets(soap_endpoint_url, soap_action, timg__GetPresets) || this->recv_GetPresets(timg__GetPresetsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int SetCurrentPreset(const char *soap_endpoint_url, const char *soap_action, _timg__SetCurrentPreset *timg__SetCurrentPreset, _timg__SetCurrentPresetResponse &timg__SetCurrentPresetResponse) { return this->send_SetCurrentPreset(soap_endpoint_url, soap_action, timg__SetCurrentPreset) || this->recv_SetCurrentPreset(timg__SetCurrentPresetResponse) ? this->error : SOAP_OK; }
