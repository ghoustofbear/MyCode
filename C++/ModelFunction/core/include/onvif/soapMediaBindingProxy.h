...
#include "soapH.h"
    ...
    class SOAP_CMAC MediaBindingProxy : public soap {
      public:
        ...
        MediaBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int GetAudioSources(const char *soap_endpoint_url, const char *soap_action, _trt__GetAudioSources *trt__GetAudioSources, _trt__GetAudioSourcesResponse &trt__GetAudioSourcesResponse) { return this->send_GetAudioSources(soap_endpoint_url, soap_action, trt__GetAudioSources) || this->recv_GetAudioSources(trt__GetAudioSourcesResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetAudioOutputs(const char *soap_endpoint_url, const char *soap_action, _trt__GetAudioOutputs *trt__GetAudioOutputs, _trt__GetAudioOutputsResponse &trt__GetAudioOutputsResponse) { return this->send_GetAudioOutputs(soap_endpoint_url, soap_action, trt__GetAudioOutputs) || this->recv_GetAudioOutputs(trt__GetAudioOutputsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetProfile(const char *soap_endpoint_url, const char *soap_action, _trt__GetProfile *trt__GetProfile, _trt__GetProfileResponse &trt__GetProfileResponse) { return this->send_GetProfile(soap_endpoint_url, soap_action, trt__GetProfile) || this->recv_GetProfile(trt__GetProfileResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetProfiles(const char *soap_endpoint_url, const char *soap_action, _trt__GetProfiles *trt__GetProfiles, _trt__GetProfilesResponse &trt__GetProfilesResponse) { return this->send_GetProfiles(soap_endpoint_url, soap_action, trt__GetProfiles) || this->recv_GetProfiles(trt__GetProfilesResponse) ? this->error : SOAP_OK; }
        ...
        virtual int AddVideoSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _trt__AddVideoSourceConfiguration *trt__AddVideoSourceConfiguration, _trt__AddVideoSourceConfigurationResponse &trt__AddVideoSourceConfigurationResponse) { return this->send_AddVideoSourceConfiguration(soap_endpoint_url, soap_action, trt__AddVideoSourceConfiguration) || this->recv_AddVideoSourceConfiguration(trt__AddVideoSourceConfigurationResponse) ? this->error : SOAP_OK; }
        ...
        virtual int AddAudioEncoderConfiguration(const char *soap_endpoint_url, const char *soap_action, _trt__AddAudioEncoderConfiguration *trt__AddAudioEncoderConfiguration, _trt__AddAudioEncoderConfigurationResponse &trt__AddAudioEncoderConfigurationResponse) { return this->send_AddAudioEncoderConfiguration(soap_endpoint_url, soap_action, trt__AddAudioEncoderConfiguration) || this->recv_AddAudioEncoderConfiguration(trt__AddAudioEncoderConfigurationResponse) ? this->error : SOAP_OK; }
        ...
        virtual int AddAudioSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _trt__AddAudioSourceConfiguration *trt__AddAudioSourceConfiguration, _trt__AddAudioSourceConfigurationResponse &trt__AddAudioSourceConfigurationResponse) { return this->send_AddAudioSourceConfiguration(soap_endpoint_url, soap_action, trt__AddAudioSourceConfiguration) || this->recv_AddAudioSourceConfiguration(trt__AddAudioSourceConfigurationResponse) ? this->error : SOAP_OK; }
        ...
        virtual int AddMetadataConfiguration(const char *soap_endpoint_url, const char *soap_action, _trt__AddMetadataConfiguration *trt__AddMetadataConfiguration, _trt__AddMetadataConfigurationResponse &trt__AddMetadataConfigurationResponse) { return this->send_AddMetadataConfiguration(soap_endpoint_url, soap_action, trt__AddMetadataConfiguration) || this->recv_AddMetadataConfiguration(trt__AddMetadataConfigurationResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetAudioSourceConfigurations(const char *soap_endpoint_url, const char *soap_action, _trt__GetAudioSourceConfigurations *trt__GetAudioSourceConfigurations, _trt__GetAudioSourceConfigurationsResponse &trt__GetAudioSourceConfigurationsResponse) { return this->send_GetAudioSourceConfigurations(soap_endpoint_url, soap_action, trt__GetAudioSourceConfigurations) || this->recv_GetAudioSourceConfigurations(trt__GetAudioSourceConfigurationsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int SetAudioSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _trt__SetAudioSourceConfiguration *trt__SetAudioSourceConfiguration, _trt__SetAudioSourceConfigurationResponse &trt__SetAudioSourceConfigurationResponse) { return this->send_SetAudioSourceConfiguration(soap_endpoint_url, soap_action, trt__SetAudioSourceConfiguration) || this->recv_SetAudioSourceConfiguration(trt__SetAudioSourceConfigurationResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetVideoSourceConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _trt__GetVideoSourceConfigurationOptions *trt__GetVideoSourceConfigurationOptions, _trt__GetVideoSourceConfigurationOptionsResponse &trt__GetVideoSourceConfigurationOptionsResponse) { return this->send_GetVideoSourceConfigurationOptions(soap_endpoint_url, soap_action, trt__GetVideoSourceConfigurationOptions) || this->recv_GetVideoSourceConfigurationOptions(trt__GetVideoSourceConfigurationOptionsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetAudioSourceConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _trt__GetAudioSourceConfigurationOptions *trt__GetAudioSourceConfigurationOptions, _trt__GetAudioSourceConfigurationOptionsResponse &trt__GetAudioSourceConfigurationOptionsResponse) { return this->send_GetAudioSourceConfigurationOptions(soap_endpoint_url, soap_action, trt__GetAudioSourceConfigurationOptions) || this->recv_GetAudioSourceConfigurationOptions(trt__GetAudioSourceConfigurationOptionsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetAudioOutputConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _trt__GetAudioOutputConfigurationOptions *trt__GetAudioOutputConfigurationOptions, _trt__GetAudioOutputConfigurationOptionsResponse &trt__GetAudioOutputConfigurationOptionsResponse) { return this->send_GetAudioOutputConfigurationOptions(soap_endpoint_url, soap_action, trt__GetAudioOutputConfigurationOptions) || this->recv_GetAudioOutputConfigurationOptions(trt__GetAudioOutputConfigurationOptionsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetStreamUri(const char *soap_endpoint_url, const char *soap_action, _trt__GetStreamUri *trt__GetStreamUri, _trt__GetStreamUriResponse &trt__GetStreamUriResponse) { return this->send_GetStreamUri(soap_endpoint_url, soap_action, trt__GetStreamUri) || this->recv_GetStreamUri(trt__GetStreamUriResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetOSDs(const char *soap_endpoint_url, const char *soap_action, _trt__GetOSDs *trt__GetOSDs, _trt__GetOSDsResponse &trt__GetOSDsResponse) { return this->send_GetOSDs(soap_endpoint_url, soap_action, trt__GetOSDs) || this->recv_GetOSDs(trt__GetOSDsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int GetOSD(const char *soap_endpoint_url, const char *soap_action, _trt__GetOSD *trt__GetOSD, _trt__GetOSDResponse &trt__GetOSDResponse) { return this->send_GetOSD(soap_endpoint_url, soap_action, trt__GetOSD) || this->recv_GetOSD(trt__GetOSDResponse) ? this->error : SOAP_OK; }
        ...
        virtual int SetOSD(const char *soap_endpoint_url, const char *soap_action, _trt__SetOSD *trt__SetOSD, _trt__SetOSDResponse &trt__SetOSDResponse) { return this->send_SetOSD(soap_endpoint_url, soap_action, trt__SetOSD) || this->recv_SetOSD(trt__SetOSDResponse) ? this->error : SOAP_OK; }
        ...
        virtual int CreateOSD(const char *soap_endpoint_url, const char *soap_action, _trt__CreateOSD *trt__CreateOSD, _trt__CreateOSDResponse &trt__CreateOSDResponse) { return this->send_CreateOSD(soap_endpoint_url, soap_action, trt__CreateOSD) || this->recv_CreateOSD(trt__CreateOSDResponse) ? this->error : SOAP_OK; }
        ...
        virtual int DeleteOSD(const char *soap_endpoint_url, const char *soap_action, _trt__DeleteOSD *trt__DeleteOSD, _trt__DeleteOSDResponse &trt__DeleteOSDResponse) { return this->send_DeleteOSD(soap_endpoint_url, soap_action, trt__DeleteOSD) || this->recv_DeleteOSD(trt__DeleteOSDResponse) ? this->error : SOAP_OK; }
