...
#include "soapH.h"
    ...
    class SOAP_CMAC PullPointSubscriptionBindingProxy : public soap {
      public:
        ...
        PullPointSubscriptionBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int Seek(const char *soap_endpoint_url, const char *soap_action, _tev__Seek *tev__Seek, _tev__SeekResponse &tev__SeekResponse) { return this->send_Seek(soap_endpoint_url, soap_action, tev__Seek) || this->recv_Seek(tev__SeekResponse) ? this->error : SOAP_OK; }
        ...
        virtual int Renew(const char *soap_endpoint_url, const char *soap_action, _wsnt__Renew *wsnt__Renew, _wsnt__RenewResponse &wsnt__RenewResponse) { return this->send_Renew(soap_endpoint_url, soap_action, wsnt__Renew) || this->recv_Renew(wsnt__RenewResponse) ? this->error : SOAP_OK; }
        ...
        /// Web service synchronous operation 'Unsubscribe' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int Unsubscribe_(const char *soap_endpoint_url, const char *soap_action, _wsnt__Unsubscribe *wsnt__Unsubscribe, _wsnt__UnsubscribeResponse &wsnt__UnsubscribeResponse) { return this->send_Unsubscribe_(soap_endpoint_url, soap_action, wsnt__Unsubscribe) || this->recv_Unsubscribe_(wsnt__UnsubscribeResponse) ? this->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_Unsubscribe' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        ...
        virtual int Subscribe(const char *soap_endpoint_url, const char *soap_action, _wsnt__Subscribe *wsnt__Subscribe, _wsnt__SubscribeResponse &wsnt__SubscribeResponse) { return this->send_Subscribe(soap_endpoint_url, soap_action, wsnt__Subscribe) || this->recv_Subscribe(wsnt__SubscribeResponse) ? this->error : SOAP_OK; }
        ...
        virtual int Notify(const char *soap_endpoint_url, const char *soap_action, _wsnt__Notify *wsnt__Notify) { return (this->send_Notify(soap_endpoint_url, soap_action, wsnt__Notify) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        ...
        /// Web service one-way synchronous send operation 'Notify' to the specified endpoint and SOAP Action header then wait for HTTP OK/Accept response, returns SOAP_OK or error code
        virtual int Notify_(const char *soap_endpoint_url, const char *soap_action, _wsnt__Notify *wsnt__Notify) { return (this->send_Notify_(soap_endpoint_url, soap_action, wsnt__Notify) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        /// Web service one-way asynchronous send operation 'send_Notify' with default endpoint and default SOAP Action header, returns SOAP_OK or error code
        ...
        /// Web service synchronous operation 'Renew' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int Renew_(const char *soap_endpoint_url, const char *soap_action, _wsnt__Renew *wsnt__Renew, _wsnt__RenewResponse &wsnt__RenewResponse) { return this->send_Renew_(soap_endpoint_url, soap_action, wsnt__Renew) || this->recv_Renew_(wsnt__RenewResponse) ? this->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_Renew' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        ...
        /// Web service synchronous operation 'Unsubscribe' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
        virtual int Unsubscribe__(const char *soap_endpoint_url, const char *soap_action, _wsnt__Unsubscribe *wsnt__Unsubscribe, _wsnt__UnsubscribeResponse &wsnt__UnsubscribeResponse) { return this->send_Unsubscribe__(soap_endpoint_url, soap_action, wsnt__Unsubscribe) || this->recv_Unsubscribe__(wsnt__UnsubscribeResponse) ? this->error : SOAP_OK; }
        /// Web service asynchronous operation 'send_Unsubscribe' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code
