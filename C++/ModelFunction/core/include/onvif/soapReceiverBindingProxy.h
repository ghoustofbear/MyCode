...
#include "soapH.h"
    ...
    class SOAP_CMAC ReceiverBindingProxy : public soap {
      public:
        ...
        ReceiverBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int ConfigureReceiver(const char *soap_endpoint_url, const char *soap_action, _trv__ConfigureReceiver *trv__ConfigureReceiver, _trv__ConfigureReceiverResponse &trv__ConfigureReceiverResponse) { return this->send_ConfigureReceiver(soap_endpoint_url, soap_action, trv__ConfigureReceiver) || this->recv_ConfigureReceiver(trv__ConfigureReceiverResponse) ? this->error : SOAP_OK; }
