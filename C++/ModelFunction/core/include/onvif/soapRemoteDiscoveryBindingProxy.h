...
#include "soapH.h"
    ...
    class SOAP_CMAC RemoteDiscoveryBindingProxy : public soap {
      public:
        ...
        RemoteDiscoveryBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int Hello(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__HelloType& tdn__Hello, struct wsdd__ResolveType &tdn__HelloResponse) { return this->send_Hello(soap_endpoint_url, soap_action, tdn__Hello) || this->recv_Hello(tdn__HelloResponse) ? this->error : SOAP_OK; }
        ...
        virtual int Bye(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__ByeType& tdn__Bye, struct wsdd__ResolveType &tdn__ByeResponse) { return this->send_Bye(soap_endpoint_url, soap_action, tdn__Bye) || this->recv_Bye(tdn__ByeResponse) ? this->error : SOAP_OK; }
        ...
        virtual int Probe(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__ProbeType& tdn__Probe, struct wsdd__ProbeMatchesType &tdn__ProbeResponse) { return this->send_Probe(soap_endpoint_url, soap_action, tdn__Probe) || this->recv_Probe(tdn__ProbeResponse) ? this->error : SOAP_OK; }
