...
#include "soapH.h"
    ...
    class SOAP_CMAC ReplayBindingProxy : public soap {
      public:
        ...
        ReplayBindingProxy(const struct soap&, const char *soap_endpoint_url);
