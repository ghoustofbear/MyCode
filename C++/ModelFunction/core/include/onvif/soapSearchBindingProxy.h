...
#include "soapH.h"
    ...
    class SOAP_CMAC SearchBindingProxy : public soap {
      public:
        ...
        SearchBindingProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int FindEvents(const char *soap_endpoint_url, const char *soap_action, _tse__FindEvents *tse__FindEvents, _tse__FindEventsResponse &tse__FindEventsResponse) { return this->send_FindEvents(soap_endpoint_url, soap_action, tse__FindEvents) || this->recv_FindEvents(tse__FindEventsResponse) ? this->error : SOAP_OK; }
        ...
        virtual int EndSearch(const char *soap_endpoint_url, const char *soap_action, _tse__EndSearch *tse__EndSearch, _tse__EndSearchResponse &tse__EndSearchResponse) { return this->send_EndSearch(soap_endpoint_url, soap_action, tse__EndSearch) || this->recv_EndSearch(tse__EndSearchResponse) ? this->error : SOAP_OK; }
        ...
        virtual int FindMetadata(const char *soap_endpoint_url, const char *soap_action, _tse__FindMetadata *tse__FindMetadata, _tse__FindMetadataResponse &tse__FindMetadataResponse) { return this->send_FindMetadata(soap_endpoint_url, soap_action, tse__FindMetadata) || this->recv_FindMetadata(tse__FindMetadataResponse) ? this->error : SOAP_OK; }
