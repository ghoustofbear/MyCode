...
#include "soapH.h"
    ...
    class SOAP_CMAC wsddProxy : public soap {
      public:
        ...
        wsddProxy(const struct soap&, const char *soap_endpoint_url);
        ...
        virtual int Hello(const char *soap_endpoint_url, const char *soap_action, struct wsdd__HelloType *wsdd__Hello) { return (this->send_Hello(soap_endpoint_url, soap_action, wsdd__Hello) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        ...
        virtual int Bye(const char *soap_endpoint_url, const char *soap_action, struct wsdd__ByeType *wsdd__Bye) { return (this->send_Bye(soap_endpoint_url, soap_action, wsdd__Bye) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        ...
        virtual int Probe(const char *soap_endpoint_url, const char *soap_action, struct wsdd__ProbeType *wsdd__Probe) { return (this->send_Probe(soap_endpoint_url, soap_action, wsdd__Probe) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        ...
        virtual int ProbeMatches(const char *soap_endpoint_url, const char *soap_action, struct wsdd__ProbeMatchesType *wsdd__ProbeMatches) { return (this->send_ProbeMatches(soap_endpoint_url, soap_action, wsdd__ProbeMatches) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        ...
        virtual int Resolve(const char *soap_endpoint_url, const char *soap_action, struct wsdd__ResolveType *wsdd__Resolve) { return (this->send_Resolve(soap_endpoint_url, soap_action, wsdd__Resolve) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
        ...
        virtual int ResolveMatches(const char *soap_endpoint_url, const char *soap_action, struct wsdd__ResolveMatchesType *wsdd__ResolveMatches) { return (this->send_ResolveMatches(soap_endpoint_url, soap_action, wsdd__ResolveMatches) || soap_recv_empty_response(this)) ? this->error : SOAP_OK; }
