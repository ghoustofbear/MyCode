...
signed short
ulaw2linear(unsigned char u)
{
    return (_u2l[u]);
}

signed short
alaw2linear(unsigned char a)
{
    return (_A2l[a]);
}

unsigned char
ulaw2alaw(unsigned char u)
{
    return (_u2A[u]);
}

unsigned char
alaw2ulaw(unsigned char a)
{
    return (_A2u[a]);
}
