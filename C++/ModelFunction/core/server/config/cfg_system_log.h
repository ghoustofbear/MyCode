 ...
 *  cfg_group.h defines
 */
#ifndef __CFG_SYSTEM_LOG_H__
#define __CFG_SYSTEM_LOG_H__
#include "observable.h"
#include "cfg.h"

class SystemLogCfg: public Cfg, public Observable
{
public:
    SystemLogCfg(int type);
    virtual ~SystemLogCfg();
...
MS_API extern SystemLogCfg* systemLogCfg;
#endif
